...
export default function ChatbotWidget() {
  ...
  const [messages, setMessages] = useState<Msg[]>([
    {
      role: "bot",
      text: "Welcome to Advancia Support. How can we assist you today with payments, cards, bookings, or account services?",
  ...
  return (
    <>
      ...
      <button
        ...
        aria-label="Open Advancia Support"
      >
        {open ? (
          "×"
        ) : (
      ...
      {open && (
        <div className="fixed right-5 bottom-[90px] w-[360px] h-[520px] z-[9999] bg-white border shadow-2xl rounded-xl flex flex-col">
          <div className="p-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-t-xl">
            ...
            <div className="text-xs opacity-90">We're here to help 24/7</div>
          </div>
